...
info@luxuryapartmentgurgaon.in</a></li>
          ...
          <div className="col-md-3 mb-4">
            ...
            <ul className="list-unstyled">
              <li><a href="/listing/1" className="text-white text-decoration-none">DLF The Arbour</a></li>
              <li><a href="/listing/2" className="text-white text-decoration-none">M3M Golf Estate</a></li>
              <li><a href="/listing/3" className="text-white text-decoration-none">Godrej Meridien</a></li>
              <li><a href="/listing/4" className="text-white text-decoration-none">Emaar Palm Heights</a></li>
            </ul>
          </div>
